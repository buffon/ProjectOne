            ...
            case MotionEvent.ACTION_UP:
               x = (int) ev.getX();
                ...
                if (itemnum == AdapterView.INVALID_POSITION)
                    ...
                    if (itemnum == 0) {
                        if (itemnum == (getAdapter().getCount() - 1)) {
                            setSelector(R.drawable.app_list_corner_round_blank);
                        } else {
                            setSelector(R.drawable.app_list_corner_round_top_blank);
                        }
                    } else if (itemnum == (getAdapter().getCount() - 1))
                        setSelector(R.drawable.app_list_corner_round_bottom_blank);
                    else {
                        setSelector(R.drawable.app_list_corner_shape_blank);
                    }
                }
                break;
        }
